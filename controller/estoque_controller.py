...
class EstoqueController:
    ...
    def adicionar_produto_estoque(self, produto : Produto, quantidade : int) -> None:
    ...
    def atualizar_quantidade(self, produto : Produto, nova_quantidade : int) -> None:
    ...
    def verificar_disponibilidade(self, produto : Produto, quantidade : int) -> bool:
